...
const Login = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: `url("https://cv-creator.co.uk/wp-content/uploads/2023/01/education-section-cv-1.jpg")`,
      ...
      <div className="flex flex-col items-center mt-10 space-y-32">
        ...
        <div className="grid grid-cols-3 gap-28">
          <div className="h-96 w-96 space-y-11 shadow-2xl flex flex-col justify-center items-center bg-transparent backdrop-blur-md bg-[#669da3] bg-opacity-60 rounded-xl">
          ...
          <div className="h-96 w-96 space-y-11 shadow-2xl flex flex-col justify-center items-center bg-transparent backdrop-blur-md bg-[#c495a1] bg-opacity-60 rounded-xl">
          ...
          <div className="h-96 w-96 space-y-11 shadow-2xl flex flex-col justify-center items-center bg-transparent backdrop-blur-md bg-[#7ca781] bg-opacity-60 rounded-xl">
